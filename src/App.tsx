...
function App() {
  const authProvider: AuthProvider = {
    login: async ({ credential }: CredentialResponse) => {
      ...
      if (profileObj) {
        const response = await fetch('https://real-estate-dashboard-2kvs.onrender.com/api/v1/users',
          {
            method: "POST",
  ...
  return (
    <ColorModeContextProvider>
      ...
      <RefineSnackbarProvider>
        <Refine
          dataProvider={dataProvider("https://real-estate-dashboard-2kvs.onrender.com/api/v1")}
